...
use super::primitives::{hash, Fr, fr_map};
...
pub struct Tree {
    ...
    // leaf (level 0) nodes idx are 0-7, level 1 nodes idx are 8-11, etc.
    #[serde(with = "fr_map")]
    data: ValueMap,
}
...
impl Tree {
    ...
    */
    ...
    fn get_flattened_idx(&self, level: usize, idx: u32) -> usize {
        (1usize << (self.height + 1)) - (1usize << (self.height - level + 1)) + (idx as usize)
    }
