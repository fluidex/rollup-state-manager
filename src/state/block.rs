...
impl Block {
    ...
    fn block_cases(&self) -> Vec<CircuitTestData> {
        ...
        let mut order2 = Order {
            ...
            total_sell: decimal_to_amount(&Decimal::new(10000, 0), prec_token_id(token_id_2to1)).to_fr(),
            filled_buy: Fr::zero(),
            filled_sell: Fr::zero(),
        ...
        let mut order1 = Order {
            ...
            total_sell: decimal_to_amount(&Decimal::new(1000, 0), prec_token_id(token_id_1to2)).to_fr(),
            filled_buy: Fr::zero(),
            filled_sell: Fr::zero(),
            sig: Signature::default(),
        };
